<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justifiy-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-3 mb-3 border-bottom">
                ...
                <div class="card-body">
                    <form action="fungsi/edit.php?jabatan=edit" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="keterangan" value="<?= $row['keterangan']; ?>"></textarea>
                        </div>
                        <button type="submit" class="btn btn-primary"><i class="fa fa-sloppy-o" aria-hidden="true"></i> Ubah</button>
