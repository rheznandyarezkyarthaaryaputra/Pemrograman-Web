...
<body>
        ...
        <form action="proses.php?aksi=ubah" method="post">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input type="radio" class="form-check-input" name="jenis_kelamin" value="L" id="laki-laki" <?php if ($row['jenis_kelamin'] == 'L') echo "checked"; ?> required>
    ...
    <script src="https://cdn.jsdelivr.net/npm/popper.js@1.7.5/dist/umd/popper.min.js"></script>
