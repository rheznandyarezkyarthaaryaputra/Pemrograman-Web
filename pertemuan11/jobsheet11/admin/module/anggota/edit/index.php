                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="jabatan" aria-label="Default select example">
                                            ...
                                            while($row2=mysqli_fetch_assoc($result2)){
                                                ...
                                                ?>
                                                <option value="<?= $row2['id']; ?>" <?= $selected; ?>><?= $row2['jabatan']; ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" name="jenis_kelamin" class="form-check-input" value="L" <?=($row['jenis_kelamin']==="L")? 'checked': ''?>>
                                            <label for="inlineRadio1" class="form-check-label">Laki-laki</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" name="jenis_kelamin" class="form-check-input" value="P" <?=($row['jenis_kelamin']==="P")? 'checked': ''?>>
