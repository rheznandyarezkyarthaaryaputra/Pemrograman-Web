                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Form Anggotaaaa</h1>
                        ...
                        <form action="fungsi/tambah.php?anggota=tambah" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="message-text" class="form-label">Alamat:</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" name="no_telp" id="recipient-name">
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="recipient-name" class="form-label">Level:</label>
                                    <select name="level" class="form-select" name aria-label="Default select example">
